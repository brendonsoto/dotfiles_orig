...
local M = {
  keymappings = {
    ...
    j = {
      function()
        hop.hint_lines_skip_whitespace({ direction = hopHint.HintDirection.AFTER_CURSOR })
      end,
      'Hop down'
    },
    k = {
      function()
        hop.hint_lines_skip_whitespace({ direction = hopHint.HintDirection.BEFORE_CURSOR })
      end,
      'Hop up'
    },
  }
